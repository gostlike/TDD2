...
namespace PotterShoppingCart.Tests
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void PotterShoppingCart價格計算測試_第一二三四集各買一本_滿足8折優惠_價格為320()
        {
            var pottershoppingcart = new List<Book>
            {
                new Book("Harry Potter Episode 1",100,1),
        ...
        [TestMethod]
        public void PotterShoppingCart價格計算測試_第一二三四五集各買一本_滿足75折優惠_價格為375()
        {
            var pottershoppingcart = new List<Book>
            {
                new Book("Harry Potter Episode 1",100,1),
        ...
        [TestMethod]
        public void PotterShoppingCart價格計算測試_第一二集各買一本_第三集買兩本_其中三本滿足9折優惠_價格為370()
        {
            var pottershoppingcart = new List<Book>
            {
                new Book("Harry Potter Episode 1",100,1),
